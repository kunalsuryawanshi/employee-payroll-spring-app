...
public class EmployeePayrollServiceTest {
    ...
    void whenGetAllMethodCalled_shouldReturnListOfEmployee() {
        ...
        employeeEntity1.setName("Kunal Suryawanshi");
        employeeEntity1.setImagePath("/img1");
        employeeEntity1.setGender("Male");
